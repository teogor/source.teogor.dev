...
(() => {
  ...
  var Z = Math.pow,
    ...
    A = (t, e) => {
      ...
      if (Y) for (var r of Y(e)) be.call(e, r) && J(t, r, e[r]);
      return t;
    },
    G = (t, e) => ve(t, Te(e));
  var Le = (t, e) => () => (
...
`,
       ...
       */ (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (
            var M = t.Set.complete, I = t.Set.empty, u = 0;
            u < this.fields.length;
            u++
          ) {
            var y = this.fields[u];
    ...
    search(e) {
      if (
        ((e = e.replace(new RegExp("\\p{sc=Han}+", "gu"), (s) =>
          [...he(s, this.index.invertedIndex)].join("* "),
        )),
        (e = ue(e)),
        !e)
      )
        ...
        n = this.index
          ...
          .reduce((s, { ref: o, score: a, matchData: u }) => {
            ...
            if (typeof c != "undefined") {
              ...
              s.push(G(A({}, c), { score: a * (1 + Z(g, 2)), terms: f }));
            }
            return s;
          }, [])
  ...
  function Fe(t) {
    return B(this, null, function* () {
      switch (t.type) {
        case 0:
          return yield Ie(t.data.config), (fe = new H(t.data)), { type: 1 };
        case 2:
          let e = t.data;
          try {
            return { type: 3, data: fe.search(e) };
          } catch (r) {
            return (
              console.warn(
