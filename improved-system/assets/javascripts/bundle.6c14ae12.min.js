...
(() => {
  ...
  var Xr = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    R = (e, t) => {
      for (var r in t || (t = {})) dr.call(t, r) && Xr(e, r, t[r]);
      if (kt) for (var r of kt(t)) Zr.call(t, r) && Xr(e, r, t[r]);
      return e;
    };
  var eo = (e, t) => {
    var r = {};
    for (var o in e) dr.call(e, o) && t.indexOf(o) < 0 && (r[o] = e[o]);
    if (e != null && kt)
      for (var o of kt(e)) t.indexOf(o) < 0 && Zr.call(e, o) && (r[o] = e[o]);
    return r;
  };
  var hr = (e, t) => () => (
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let n of Ti(t))
        !dr.call(e, n) &&
          ...
          ur(e, n, {
            get: () => t[n],
            enumerable: !(o = Si(t, n)) || o.enumerable,
          });
    return e;
  };
  var Ht = (e, t, r) => (
  ...
  var ro = hr((br, to) => {
    (function (e, t) {
      typeof br == "object" && typeof to != "undefined"
        ? t()
      ...
      function e(r) {
        ...
        function c(C) {
          var it = C.type,
            Ue = C.tagName;
          return !!(
            (Ue === "INPUT" && s[it] && !C.readOnly) ||
            (Ue === "TEXTAREA" && !C.readOnly) ||
            C.isContentEditable
          );
        }
        function p(C) {
  ...
  var Vr = hr((Ot, Dr) => {
     ...
     */ (function (t, r) {
      typeof Ot == "object" && typeof Dr == "object"
        ? (Dr.exports = r())
        : typeof define == "function" && define.amd
          ? define([], r)
          : typeof Ot == "object"
        ...
        var e = {
            686: function (o, n, i) {
              ...
              var d = function (O) {
                ...
                v = d;
              function b(W) {
                var O = document.documentElement.getAttribute("dir") === "rtl",
                ...
                (S.style.fontSize = "12pt"),
                  ...
                  (S.style[O ? "right" : "left"] = "-9999px");
                var $ =
                  window.pageYOffset || document.documentElement.scrollTop;
                return (
                  (S.style.top = "".concat($, "px")),
              ...
              var it = function () {
                  ...
                  if (Q !== void 0)
                    if (Q && C(Q) === "object" && Q.nodeType === 1) {
                      if ($ === "copy" && Q.hasAttribute("disabled"))
                        throw new Error(
                          'Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute',
                        );
                      if (
                        $ === "cut" &&
                        (Q.hasAttribute("readonly") ||
                  ...
                  if (_e) return G(_e, { container: F });
                  if (Q) return $ === "cut" ? v(Q) : G(Q, { container: F });
                },
                Ue = it;
              function Pe(W) {
                "@babel/helpers - typeof";
              ...
              function di(W, O, S) {
                return O && Jr(W.prototype, O), S && Jr(W, S), W;
              }
              function hi(W, O) {
              ...
              function bi(W) {
                ...
                return function () {
                  var $ = At(W),
                    F;
                  if (O) {
                    var Q = At(this).constructor;
                    F = Reflect.construct($, arguments, Q);
                  } else F = $.apply(this, arguments);
                  return vi(this, F);
                };
              }
              function vi(W, O) {
                return O && (Pe(O) === "object" || typeof O == "function")
                  ? O
                  : gi(W);
              }
              function gi(W) {
              ...
              function fr(W, O) {
                var S = "data-clipboard-".concat(W);
                if (O.hasAttribute(S)) return O.getAttribute(S);
              }
              var yi = (function (W) {
                  hi(S, W);
                  var O = bi(S);
                    ...
                    di(
                      ...
                      [
                        ...
                        },
                        {
                          ...
                          value: function (F) {
                            var Q = this;
                            this.listener = p()(F, "click", function (_e) {
                              return Q.onClick(_e);
                            });
                          },
                        },
                        {
                          key: "onClick",
                          value: function (F) {
                            var Q = F.delegateTarget || F.currentTarget,
                              _e = this.action(Q) || "copy",
                              Ct = Ue({
                                action: _e,
                          ...
                          value: function () {
                            var F =
                                arguments.length > 0 && arguments[0] !== void 0
                                  ? arguments[0]
                                  : ["copy", "cut"],
                              Q = typeof F == "string" ? [F] : F,
                              _e = !!document.queryCommandSupported;
                            return (
                              Q.forEach(function (Ct) {
                                _e = _e && !!document.queryCommandSupported(Ct);
                              }),
                              _e
                            );
                          },
            ...
            438: function (o, n, i) {
              ...
              function a(l, f, u, d, v) {
                ...
                return (
                  l.addEventListener(u, b, v),
                  {
                    destroy: function () {
                      l.removeEventListener(u, b, v);
                    },
                  }
                );
              }
                ...
                return typeof l.addEventListener == "function"
                  ...
                  : typeof u == "function"
                    ...
                    : (typeof l == "string" &&
                      ...
                      Array.prototype.map.call(l, function (b) {
                        return a(b, f, u, d, v);
                      }));
              }
              function p(l, f, u, d) {
            ...
            370: function (o, n, i) {
              ...
              function l(u, d, v) {
                return (
                  Array.prototype.forEach.call(u, function (b) {
                    b.addEventListener(d, v);
                  }),
                  {
                    destroy: function () {
                      Array.prototype.forEach.call(u, function (b) {
                        b.removeEventListener(d, v);
                      });
                    },
                  }
                );
...
***************************************************************************** */ var vr =
  ...
  function no(e, t, r) {
    ...
    function f(u, d) {
      u(d), i.shift(), i.length && a(i[0][0], i[0][1]);
    }
  }
  function io(e) {
    if (!Symbol.asyncIterator)
    ...
    return t
      ? t.call(e)
      : ((e = typeof we == "function" ? we(e) : e[Symbol.iterator]()),
        (r = {}),
        o("next"),
        o("throw"),
        o("return"),
...
` +
        ...
        if (!this.closed) {
          ...
          if (k(l))
            try {
              ...
              i = b instanceof Rt ? b.errors : [b];
            }
          var f = this._finalizers;
          if (f) {
            this._finalizers = null;
            try {
              for (var u = we(f), d = u.next(); !d.done; d = u.next()) {
                var v = d.value;
                try {
                  ao(v);
                } catch (b) {
  ...
  var st = {
    setTimeout: function (e, t) {
      ...
      return n != null && n.setTimeout
        ? n.setTimeout.apply(n, D([e, t], N(r)))
        : setTimeout.apply(void 0, D([e, t], N(r)));
    },
  ...
  var xt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (o.isStopped = !1),
        r ? ((o.destination = r), Pt(r) && r.add(o)) : (o.destination = Ci),
        o
      );
    }
    return (
      ...
      (t.prototype.next = function (r) {
        this.isStopped ? Er(po(r), this) : this._next(r);
      }),
    ...
    tt = (function (e) {
      ...
      function t(r, o, n) {
        ...
        if (k(r) || !r)
          ...
          var a;
          i && Ae.useDeprecatedNextContext
            ? ((a = Object.create(r)),
              (a.unsubscribe = function () {
                return i.unsubscribe();
              }),
              (s = {
                next: r.next && yr(r.next, a),
                error: r.error && yr(r.error, a),
                complete: r.complete && yr(r.complete, a),
              }))
            : (s = r);
        }
        return (i.destination = new _i(s)), i;
      }
      return t;
    })(xt);
  function Ft(e) {
    Ae.useDeprecatedSynchronousErrorHandling ? lo(e) : It(e);
  }
  function Ai(e) {
    throw e;
  }
  function Er(e, t) {
    var r = Ae.onStoppedNotification;
    r &&
      st.setTimeout(function () {
        return r(e, t);
      });
  }
  var Ci = { closed: !0, next: fe, error: Ai, complete: fe };
  var pt = (function () {
  ...
  function fo(e) {
    var t;
    return (t = e != null ? e : Ae.Promise) !== null && t !== void 0
      ? t
      : Promise;
  }
  function ki(e) {
  ...
  function Hi(e) {
    return (e && e instanceof xt) || (ki(e) && Pt(e));
  }
  function $i(e) {
      ...
      (t.prototype.next = function (r) {
        ...
        ct(function () {
          ...
          if ((o._throwIfClosed(), !o.isStopped)) {
            ...
            try {
              for (
                var s = we(o.currentObservers), a = s.next();
                !a.done;
                a = s.next()
              ) {
                var c = a.value;
      ...
      (t.prototype._innerSubscribe = function (r) {
        ...
        return i || s
          ...
          : ((this.currentObservers = null),
            a.push(r),
            new Ie(function () {
              (o.currentObservers = null), De(a, r);
            }));
      }),
  ...
  var wt = {
    setInterval: function (e, t) {
      ...
      return n != null && n.setInterval
        ? n.setInterval.apply(n, D([e, t], N(r)))
        : setInterval.apply(void 0, D([e, t], N(r)));
    },
  ...
  var jt = (function (e) {
    ...
    return (
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          n === void 0 && (n = 0), wt.setInterval(r.flush.bind(r, this), n)
        );
      }),
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          ...
          n !== null && n > 0
            ...
            : (r.actions.push(this),
              r._scheduled ||
                (r._scheduled = lt.requestAnimationFrame(function () {
      ...
      (t.prototype.recycleAsyncId = function (r, o, n) {
        ...
        o != null &&
          ((i = s[s.length - 1]) === null || i === void 0 ? void 0 : i.id) !==
            o &&
          (lt.cancelAnimationFrame(o), (r._scheduled = void 0));
      }),
      t
    );
  })(jt);
  ...
  function Qe(e) {
    return k(Or(e)) ? e.pop() : void 0;
  }
  function Me(e) {
    return Nt(Or(e)) ? e.pop() : void 0;
  }
  function Ut(e, t) {
    return typeof Or(e) == "number" ? e.pop() : t;
  }
  var mt = function (e) {
  ...
  var Kt = Pi();
  function Qt(e) {
    return k(e == null ? void 0 : e[Kt]);
  }
  function Yt(e) {
    return no(this, arguments, function () {
      var r, o, n, i;
  ...
  function Wi(e) {
    return new P(function (t) {
      var r, o;
      try {
        for (var n = we(e), i = n.next(); !i.done; i = n.next()) {
          var s = i.value;
  ...
  function Ui(e, t) {
    ...
    return oo(this, void 0, void 0, function () {
      ...
      return $t(this, function (c) {
        switch (c.label) {
          case 0:
            c.trys.push([0, 5, 6, 11]), (r = io(e)), (c.label = 1);
          case 1:
            return [4, r.next()];
          case 2:
  ...
  function Oo(e, t) {
    if (e != null) {
      if (Vt(e)) return yo(e, t);
      if (mt(e)) return wo(e, t);
      if (Dt(e)) return Eo(e, t);
      if (zt(e)) return Gt(e, t);
      if (Qt(e)) return So(e, t);
      if (Bt(e)) return To(e, t);
    }
    throw qt(e);
  }
  function ge(e, t) {
  ...
  function Vi(e, t) {
    return Di(t) ? e.apply(void 0, D([], N(t))) : e(t);
  }
  function Ye(e) {
    return m(function (t) {
      return Vi(e, t);
  ...
  function Yi(e) {
    return e && typeof e == "object" && qi(e) === Ki;
  }
  function _o(e, t) {
  ...
  var Bi = ["addListener", "removeListener"],
    Gi = ["addEventListener", "removeEventListener"],
    Ji = ["on", "off"];
  function h(e, t, r, o) {
    if ((k(r) && ((o = r), (r = void 0)), o)) return h(e, t, r).pipe(Ye(o));
    var n = N(
        ea(e)
          ? Gi.map(function (a) {
              return function (c) {
  ...
  function Be(e, t, r) {
    e === void 0 && (e = 0), r === void 0 && (r = Tr);
    var o = -1;
    return (
      t != null && (Nt(t) ? (r = t) : (o = t)),
      new P(function (n) {
        var i = Mo(e) ? +e - r.now() : e;
        i < 0 && (i = 0);
        var s = 0;
  ...
  function _() {
    ...
    var r = Me(e),
      o = Ut(e, 1 / 0),
      n = e;
    return n.length ? (n.length === 1 ? I(n[0]) : ft(o)(ge(n, r))) : L;
  }
  var Ve = new P(fe);
  var ta = Array.isArray;
  function ut(e) {
    return e.length === 1 && ta(e[0]) ? e[0] : e;
  }
  function M(e, t) {
    return g(function (r, o) {
      var n = 0;
                  ...
                  y(
                    ...
                    function (l) {
                      if (
                        ...
                        n.next(r ? r.apply(void 0, D([], N(f))) : f),
                          i.some(function (u, d) {
                            return !u.length && s[d];
                          }) && n.complete();
                      }
    ...
    return g(function (t, r) {
      ...
      t.subscribe(
        y(
          r,
          function (p) {
            (o = !0), (n = p), i || I(e(p)).subscribe((i = y(r, a, c)));
          },
          function () {
        ...
        r.subscribe(
          y(
            ...
            function (s) {
              ...
              i++ % t === 0 && n.push([]);
              try {
                for (var u = we(n), d = u.next(); !d.done; d = u.next()) {
                  var v = d.value;
                  v.push(s),
              ...
              if (f)
                try {
                  for (var b = we(f), z = b.next(); !z.done; z = b.next()) {
                    var v = z.value;
                    De(n, v), o.next(v);
                  }
                } catch (K) {
            ...
            function () {
              var s, a;
              try {
                for (var c = we(n), p = c.next(); !p.done; p = c.next()) {
                  var l = p.value;
                  o.next(l);
                }
              } catch (f) {
  ...
  function Ar(e, t) {
    return t
      ? function (r) {
          return Fe(t.pipe(xe(1), Z()), r.pipe(Ar(e)));
        }
      : ce(function (r, o) {
          return I(e(r, o)).pipe(xe(1), Po(r));
        });
  }
  function ze(e, t) {
    t === void 0 && (t = ae);
  ...
  function re() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return function (r) {
      return Fe(r, j.apply(void 0, D([], N(e))));
    };
  }
  function A(e) {
    return g(function (t, r) {
  ...
  function Fo() {
    ...
    return (
      (e = ut(e)),
      g(function (n, i) {
        ft(o)(ge(D([n], N(e)), r)).subscribe(i);
      })
    );
  }
  function qe() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return Fo.apply(void 0, D([], N(e)));
  }
  function Tt(e) {
    var t,
      r = 1 / 0,
            ...
            var s = 0,
              ...
              c = function () {
                if ((a == null || a.unsubscribe(), (a = null), o != null)) {
                  var l = typeof o == "number" ? Be(o) : I(o(s)),
                    f = y(i, function () {
                      f.unsubscribe(), p();
                    });
                  l.subscribe(f);
  ...
  function kr(e, t) {
    return g(Ro(e, t, arguments.length >= 2, !0));
  }
  function le(e) {
    e === void 0 && (e = {});
    var t = e.connector,
    ...
    return function (p) {
      var l,
        ...
        G = function () {
          var C = l;
          K(), C == null || C.unsubscribe();
        };
      return g(function (C, it) {
        d++, !b && !v && z();
        var Ue = (u = u != null ? u : r());
        it.add(function () {
          d--, d === 0 && !b && !v && (f = Hr(G, c));
          ...
          !l &&
            ...
            ((l = new tt({
              ...
              error: function (Pe) {
                (b = !0), z(), (f = Hr(K, n, Pe)), Ue.error(Pe);
              },
              complete: function () {
                (v = !0), z(), (f = Hr(K, s)), Ue.complete();
              },
            })),
            I(C).subscribe(l));
      })(p);
  ...
  function Hr(e, t) {
    ...
    if (t !== !1) {
      ...
      return I(t.apply(void 0, D([], N(r)))).subscribe(n);
    }
  }
  function J(e, t, r) {
    var o,
  ...
  function jo(e, t) {
    return g(function (r, o) {
      var n = t != null ? t : {},
        ...
        b = function (K) {
          return (f = I(e(K)).subscribe(y(o, d, v)));
        },
        z = function () {
          if (p) {
            p = !1;
            var K = l;
            (l = null), o.next(K), !u && b(K);
          }
        };
      r.subscribe(
        y(
    ...
    return g(function (o, n) {
      ...
      o.subscribe(
        y(n, function (f) {
          if (c) {
            var u = D([f], N(s));
            n.next(r ? r.apply(void 0, D([], N(u))) : u);
          }
        }),
      );
    });
  ...
  function Wo() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return g(function (r, o) {
      St.apply(void 0, D([r], N(e))).subscribe(o);
    });
  }
  function Ir() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return Wo.apply(void 0, D([], N(e)));
  }
  function No() {
    let e = new Et(1);
    return (
  ...
  var na = _(h(document.body, "focusin"), h(document.body, "focusout")).pipe(
    ke(1),
    V(void 0),
    m(() => Re() || document.body),
    J(1),
  ...
  function Uo(e) {
    return _(h(window, "load"), h(window, "resize")).pipe(
      Ce(0, Oe),
      m(() => Je(e)),
      V(Je(e)),
    );
  ...
  function dt(e) {
    return _(h(e, "scroll"), h(window, "resize")).pipe(
      Ce(0, Oe),
      m(() => er(e)),
      V(er(e)),
    );
  ...
  function Do(e, t) {
    ...
    else if (Array.isArray(t)) for (let r of t) Do(e, r);
  }
  function T(e, t, ...r) {
    ...
    return H(
      () => (
        ...
        _(
          h(t, "load"),
          h(t, "error").pipe(
            E(() => Mr(() => new ReferenceError(`Invalid script: ${e}`))),
          ),
        ).pipe(
          m(() => {}),
  ...
  var Vo = new x(),
    ia = H(() =>
      typeof ResizeObserver == "undefined"
        ? ht("https://unpkg.com/resize-observer-polyfill")
        : j(void 0),
    ).pipe(
      m(
        () =>
          new ResizeObserver((e) => {
            for (let t of e) Vo.next(t);
          }),
      ),
      E((e) => _(Ve, j(e)).pipe(A(() => e.disconnect()))),
      J(1),
    );
  function he(e) {
  ...
  function Yo() {
    let e = h(window, "keydown").pipe(
      M((t) => !(t.metaKey || t.ctrlKey)),
      m((t) => ({
        mode: Qo("search") ? "search" : "global",
        type: t.key,
        claim() {
      ...
      M(({ mode: t, type: r }) => {
        if (t === "global") {
          let o = Re();
          if (typeof o != "undefined") return !sa(o, r);
        }
        return !0;
      }),
      le(),
    );
    return ca().pipe(E((t) => (t ? L : e)));
  }
  function pe() {
    return new URL(location.href);
  }
  function ot(e, t = !1) {
    if (te("navigation.instant") && !t) {
      let r = T("a", { href: e.href });
  ...
  function pa(e) {
    return _(h(window, "hashchange"), e).pipe(
      m(Go),
      V(Go()),
      M((t) => t.length > 0),
      J(1),
  ...
  function Jo(e) {
    return pa(e).pipe(
      m((t) => se(`[id="${t}"]`)),
      M((t) => typeof t != "undefined"),
    );
  }
  function Fr(e) {
    let t = matchMedia(e);
    return Xt((r) => t.addListener(() => r(t.matches))).pipe(V(t.matches));
  }
  function Xo() {
    ...
    return new P((r) => {
      ...
      o.open("GET", `${e}`),
        ...
        o.addEventListener("abort", () => {
          r.error(new Error("Request aborted"));
        }),
        typeof (t == null ? void 0 : t.progress$) != "undefined" &&
          (o.addEventListener("progress", (n) => {
            if (n.lengthComputable)
              ...
              t.progress$.next((n.loaded / i) * 100);
            }
          }),
          t.progress$.next(5)),
        o.send();
  ...
  function on() {
    return h(window, "resize", { passive: !0 }).pipe(m(rn), V(rn()));
  }
  function nn() {
    return B([tn(), on()]).pipe(
  ...
  function ar(e, { viewport$: t, header$: r }) {
    let o = t.pipe(ee("size")),
      n = B([o, r]).pipe(m(() => Je(e)));
    return B([r, t, n]).pipe(
  ...
  function an(e, t = new Worker(e)) {
    let r = la(t),
      o = ma(t),
      n = new x();
    n.subscribe(o);
    let i = o.pipe(Z(), re(!0));
    return n.pipe(Z(), qe(r.pipe(Y(i))), le());
  }
  var fa = U("#__config"),
    vt = JSON.parse(fa.textContent);
  vt.base = `${new URL(vt.base, pe())}`;
  function me() {
    return vt;
  }
  function te(e) {
  ...
  function be(e, t) {
    return typeof t != "undefined"
      ? vt.translations[e].replace("#", t.toString())
      : vt.translations[e];
  }
  function Ee(e, t = document) {
    return U(`[data-md-component=${e}]`, t);
  }
  function oe(e, t = document) {
    return q(`[data-md-component=${e}]`, t);
  }
  function ua(e) {
    let t = U(".md-typeset > :first-child", e);
  ...
  function sn(e) {
    if (!te("announce.dismiss") || !e.childElementCount) return L;
    if (!e.hidden) {
      let t = U(".md-typeset", e);
  ...
  function Wr(e) {
    return T(
      "div",
      { class: "md-tooltip", id: e },
      T("div", { class: "md-tooltip__inner md-typeset" }),
    );
  }
  function ln(e, t) {
    if (((t = t ? `${t}_annotation_${e}` : void 0), t)) {
      ...
      return T(
        ...
        T(
          ...
          T("span", { "data-md-annotation-id": e }),
        ),
      );
    } else
      return T(
  ...
  function Nr(e, t) {
    ...
    return T(
      ...
      T(
        ...
        r > 0 && T("div", { class: "md-search-result__icon md-icon" }),
          ...
          e.tags.map((c) => {
            let p = a
              ? c in a
                ...
                : "md-tag-icon"
              : "";
            return T("span", { class: `md-tag ${p}` }, c);
          }),
        o > 0 &&
          n.length > 0 &&
          T(
  ...
  function fn(e) {
                ...
                T(
                  ...
                  T(
                    ...
                    c.length > 0 && c.length === 1
                      ...
                      : be("search.result.more.other", c.length),
                  ),
                ),
                ...c.map((l) => Nr(l, 1)),
              ),
    ...
    return T("li", { class: "md-search-result__item" }, p);
  }
  function un(e) {
    return T(
      "ul",
  ...
  function dn(e) {
    return T(
      ...
      T("div", { class: "md-typeset__table" }, e),
    );
  }
  function ba(e) {
    let t = me(),
    ...
    return T(
      ...
      T("a", { href: `${r}`, class: "md-version__link" }, e.title),
    );
  }
  function hn(e, t) {
    return T(
      ...
      T(
        "button",
        { class: "md-version__current", "aria-label": be("select.version") },
        t.title,
      ),
      T("ul", { class: "md-version__list" }, e.map(ba)),
    );
  }
  function va(e) {
    return e.tagName === "CODE" ? q(".c, .c1, .cm", e) : [e];
  }
  function ga(e) {
    let t = [];
    for (let r of va(e)) {
  ...
  function sr(e, t, { target$: r, print$: o }) {
    let n = t.closest("[id]"),
      i = n == null ? void 0 : n.id,
      s = new Map();
    for (let a of ga(t)) {
      let [, c] = a.textContent.match(/\((\d+)\)/);
      se(`:scope > li:nth-child(${c})`, e) &&
        (s.set(c, ln(c, i)), a.replaceWith(s.get(c)));
    }
    return s.size === 0
      ? L
      : H(() => {
          let a = new x(),
            ...
            p = [];
          for (let [l, f] of s)
            p.push([U(".md-typeset", f), U(`:scope > li:nth-child(${l})`, e)]);
          return (
            o.pipe(Y(c)).subscribe((l) => {
              (e.hidden = !l), e.classList.toggle("md-annotation-list", l);
              for (let [f, u] of p) l ? bn(f, u) : bn(u, f);
            }),
            _(...[...s].map(([, l]) => pn(l, t, { target$: r }))).pipe(
              A(() => a.complete()),
              le(),
            )
          );
  ...
  function vn(e) {
    if (e.nextElementSibling) {
      ...
      if (t.tagName === "P" && !t.children.length) return vn(t);
    }
  }
  function gn(e, t) {
    return H(() => {
      let r = vn(e);
      return typeof r != "undefined" ? sr(r, e, t) : L;
    });
  }
  var yn = Ht(Vr());
  var xa = 0;
  ...
  function xn(e) {
    return ye(e).pipe(
      m(({ width: t }) => ({ scrollable: bt(e).width > t })),
      ee("scrollable"),
    );
  }
  function wn(e, t) {
    let { matches: r } = matchMedia("(hover)"),
      o = H(() => {
        let n = new x();
        if (
          (n.subscribe(({ scrollable: s }) => {
            s && r
              ? e.setAttribute("tabindex", "0")
              : e.removeAttribute("tabindex");
          }),
          yn.default.isSupported() &&
            (e.closest(".copy") ||
              (te("content.code.copy") && !e.closest(".no-copy"))))
        ) {
          let s = e.closest("pre");
          (s.id = `__code_${xa++}`), s.insertBefore(mn(s.id), e);
        }
        ...
        if (i instanceof HTMLElement) {
          ...
          if (
            typeof s != "undefined" &&
            (i.classList.contains("annotate") || te("content.code.annotate"))
          ) {
            let a = sr(s, e, t);
            return xn(e).pipe(
              w((c) => n.next(c)),
  ...
  function ya(e, { target$: t, print$: r }) {
    let o = !0;
    return _(
      t.pipe(
  ...
  function Sa() {
    return typeof mermaid == "undefined" || mermaid instanceof Element
      ? ht("https://unpkg.com/mermaid@9.4.3/dist/mermaid.min.js")
      : j(void 0);
  }
  function On(e) {
    return (
      ...
      zr.subscribe(() => {
        ...
        let t = `__mermaid_${wa++}`,
          r = T("div", { class: "mermaid" }),
          o = e.textContent;
        mermaid.mermaidAPI.render(t, o, (n, i) => {
  ...
  var Mn = T("table");
  function Ln(e) {
    return e.replaceWith(Mn), Mn.replaceWith(dn(e)), j({ ref: e });
  }
  function Ta(e) {
    let t = q(":scope > input", e),
      r = t.find((o) => o.checked) || t[0];
    return _(
      ...t.map((o) => h(o, "change").pipe(m(() => U(`label[for="${o.id}"]`)))),
    ).pipe(
      V(U(`label[for="${r.id}"]`)),
      m((o) => ({ active: o })),
    );
  }
  function _n(e, { viewport$: t }) {
    let r = Ur("prev");
    e.append(r);
    let o = Ur("next");
    e.append(o);
    let n = U(".tabbed-labels", e);
    return H(() => {
      let i = new x(),
        s = i.pipe(Z(), re(!0));
      return (
        B([i, ye(e)])
          ...
          .subscribe({
            next([{ active: a }, c]) {
              let p = Je(a),
                { width: l } = he(a);
              e.style.setProperty("--md-indicator-x", `${p.x}px`),
                e.style.setProperty("--md-indicator-width", `${l}px`);
              let f = er(n);
              (p.x < f.x || p.x + l > f.x + c.width) &&
                n.scrollTo({ left: Math.max(0, p.x - 16), behavior: "smooth" });
            },
            complete() {
        ...
        B([dt(n), ye(n)])
          ...
          .subscribe(([a, c]) => {
            let p = bt(n);
            (r.hidden = a.x < 16), (o.hidden = a.x > p.width - c.width - 16);
          }),
        _(h(r, "click").pipe(m(() => -1)), h(o, "click").pipe(m(() => 1)))
          .pipe(Y(s))
          .subscribe((a) => {
            let { width: c } = he(n);
            n.scrollBy({ left: c * a, behavior: "smooth" });
          }),
        te("content.tabs.link") &&
          i.pipe(je(1), ne(t)).subscribe(([{ active: a }, { offset: c }]) => {
            let p = a.innerText.trim();
            if (a.hasAttribute("data-md-switching"))
              a.removeAttribute("data-md-switching");
            else {
              let l = e.offsetTop - c.y;
              for (let u of q("[data-tabs]"))
                for (let d of q(":scope > input", u)) {
                  let v = U(`label[for="${d.id}"]`);
                  if (v !== a && v.innerText.trim() === p) {
                    v.setAttribute("data-md-switching", ""), d.click();
                    break;
                  }
                }
              window.scrollTo({ top: e.offsetTop - l });
              let f = __md_get("__tabs") || [];
              __md_set("__tabs", [...new Set([p, ...f])]);
            }
          }),
        i.pipe(Y(s)).subscribe(() => {
          for (let a of q("audio, video", e)) a.pause();
        }),
        Ta(e).pipe(
          w((a) => i.next(a)),
          A(() => i.complete()),
  ...
  function An(e, { viewport$: t, target$: r, print$: o }) {
    return _(
      ...q(".annotate:not(.highlight)", e).map((n) =>
        gn(n, { target$: r, print$: o }),
      ),
      ...q("pre:not(.mermaid) > code", e).map((n) =>
        wn(n, { target$: r, print$: o }),
      ),
      ...q("pre.mermaid", e).map((n) => On(n)),
      ...q("table:not([class])", e).map((n) => Ln(n)),
      ...q("details", e).map((n) => Sn(n, { target$: r, print$: o })),
      ...q("[data-tabs]", e).map((n) => _n(n, { viewport$: t })),
    );
  }
  function Oa(e, { alert$: t }) {
    return t.pipe(
      E((r) =>
        _(j(!0), j(!1).pipe(ze(2e3))).pipe(
  ...
  function Ma({ viewport$: e }) {
    if (!te("header.autohide")) return j(!1);
    let t = e.pipe(
        m(({ offset: { y: n } }) => n),
        Le(2, 1),
        m(([n, i]) => [n < i, i]),
      ...
      r = B([e, t]).pipe(
        M(([{ offset: n }, [, i]]) => Math.abs(i - n.y) > 100),
        m(([, [n]]) => n),
        X(),
      ),
      o = We("search");
  ...
  function kn(e, t) {
    return H(() => B([ye(e), Ma(t)])).pipe(
      m(([{ height: r }, o]) => ({ height: r, hidden: o })),
      X((r, o) => r.height === o.height && r.hidden === o.hidden),
      J(1),
    );
  }
  function Hn(e, { header$: t, main$: r }) {
    return H(() => {
      let o = new x(),
        n = o.pipe(Z(), re(!0));
      return (
  ...
  function La(e, { viewport$: t, header$: r }) {
    return ar(e, { viewport$: t, header$: r }).pipe(
      m(({ offset: { y: o } }) => {
        let { height: n } = he(e);
        return { active: o >= n };
      }),
  ...
  function Rn(e, { viewport$: t, header$: r }) {
    let o = r.pipe(
        m(({ height: i }) => i),
        X(),
      ),
  ...
  function Pn(e) {
    let t = T("meta", { name: "theme-color" });
    document.head.appendChild(t);
    let r = T("meta", { name: "color-scheme" });
    return (
      ...
      H(() => {
        ...
        o.subscribe((i) => {
          ...
          for (let [s, a] of Object.entries(i.color))
            document.body.setAttribute(`data-md-color-${s}`, a);
          for (let s = 0; s < n.length; s++) {
            let a = n[s].nextElementSibling;
  ...
  function Fn({ alert$: e }) {
    qr.default.isSupported() &&
      new P((t) => {
        new qr.default("[data-clipboard-target], [data-clipboard-text]", {
          text: (r) =>
            r.getAttribute("data-clipboard-text") ||
            Aa(U(r.getAttribute("data-clipboard-target"))),
  ...
  function Ca(e) {
    ...
    let [t, r] = [...e]
        .sort((n, i) => n.length - i.length)
        .map((n) => n.replace(/[^/]+$/, "")),
      o = 0;
    if (t === r) o = t.length;
    else for (; t.charCodeAt(o) === r.charCodeAt(o); ) o++;
    return e.map((n) => n.replace(t.slice(0, o), ""));
  }
  function cr(e) {
    ...
    {
      let r = me();
      return Zo(new URL("sitemap.xml", e || r.base)).pipe(
        m((o) => Ca(q("loc", o).map((n) => n.textContent))),
        de(() => L),
        He([]),
        w((o) => __md_set("__sitemap", o, sessionStorage, e)),
      );
    }
  }
  function jn(e) {
    let t = se("[rel=canonical]", e);
    typeof t != "undefined" &&
      (t.href = t.href.replace("//localhost:", "//127.0.0.1:"));
    let r = new Map();
    for (let o of q(":scope > *", e)) {
      let n = o.outerHTML;
      for (let i of ["href", "src"]) {
        let s = o.getAttribute(i);
        if (s === null) continue;
        let a = new URL(s, t == null ? void 0 : t.href),
          c = o.cloneNode();
        c.setAttribute(i, `${a}`), (n = c.outerHTML);
        break;
      }
      r.set(n, o);
    }
  ...
  function Wn({ location$: e, viewport$: t, progress$: r }) {
    let o = me();
    if (location.protocol === "file:") return L;
    let n = cr().pipe(m((l) => l.map((f) => `${new URL(f, o.base)}`))),
      i = h(document.body, "click").pipe(
        ne(n),
        E(([l, f]) => {
          if (!(l.target instanceof Element)) return L;
          let u = l.target.closest("a");
          if (u === null) return L;
          if (u.target || l.metaKey || l.ctrlKey) return L;
          let d = new URL(u.href);
          return (
            (d.search = d.hash = ""),
            f.includes(`${d}`) ? (l.preventDefault(), j(new URL(u.href))) : L
          );
        }),
        le(),
      );
    i.pipe(xe(1)).subscribe(() => {
      let l = se("link[rel=icon]");
      typeof l != "undefined" && (l.href = l.href);
    }),
      h(window, "beforeunload").subscribe(() => {
        history.scrollRestoration = "auto";
      }),
      i.pipe(ne(t)).subscribe(([l, { offset: f }]) => {
    ...
    let s = e.pipe(
        ...
        ee("pathname"),
        je(1),
        E((l) => ir(l, { progress$: r }).pipe(de(() => (ot(l, !0), L)))),
      ),
      a = new DOMParser(),
      c = s.pipe(
        E((l) => l.text()),
        E((l) => {
          let f = a.parseFromString(l, "text/html");
          for (let b of [
          ...
          let u = jn(document.head),
            d = jn(f.head);
          for (let [b, z] of d)
            z.getAttribute("rel") === "stylesheet" ||
              z.hasAttribute("src") ||
              (u.has(b) ? u.delete(b) : document.head.appendChild(z));
          for (let b of u.values())
            b.getAttribute("rel") === "stylesheet" ||
              b.hasAttribute("src") ||
              b.remove();
          let v = Ee("container");
          return Fe(q("script", v)).pipe(
            E((b) => {
              let z = f.createElement("script");
              if (b.src) {
                for (let K of b.getAttributeNames())
                  z.setAttribute(K, b.getAttribute(K));
                return (
                  b.replaceWith(z),
                  new P((K) => {
                    z.onload = () => K.complete();
                ...
                return (z.textContent = b.textContent), b.replaceWith(z), L;
            }),
            Z(),
            re(f),
          );
    ...
    return (
      h(window, "popstate").pipe(m(pe)).subscribe(e),
      e
        .pipe(
          V(pe()),
          Le(2, 1),
          M(([l, f]) => l.pathname === f.pathname && l.hash !== f.hash),
          m(([, l]) => l),
        )
        .subscribe((l) => {
          var f, u;
          history.state !== null || !l.hash
            ? window.scrollTo(
                0,
                (u = (f = history.state) == null ? void 0 : f.y) != null
                  ? u
                  : 0,
              )
            : ((history.scrollRestoration = "auto"),
      ...
      c.pipe(ne(e)).subscribe(([, l]) => {
        var f, u;
        history.state !== null || !l.hash
          ? window.scrollTo(
              0,
              (u = (f = history.state) == null ? void 0 : f.y) != null ? u : 0,
            )
          : nr(l.hash);
      }),
      t.pipe(ee("offset"), ke(100)).subscribe(({ offset: l }) => {
  ...
  function zn(e, t) {
    let r = an(e);
    return (
      _(j(location.protocol !== "file:"), We("search"))
        .pipe(
          $e((o) => o),
          E(() => t),
        )
        .subscribe(({ config: o, docs: n }) =>
          r.next({
            ...
            data: {
              config: o,
              docs: n,
              options: { suggest: te("search.suggest") },
            },
          }),
        ),
      r
  ...
  function qn({ document$: e }) {
    let t = me(),
      r = Ne(new URL("../versions.json", t.base)).pipe(de(() => L)),
      o = r.pipe(
        m((n) => {
          let [, i] = t.base.match(/([^/]+)\/?$/);
          return (
    ...
    r
        ...
        E((n) =>
          h(document.body, "click").pipe(
            ...
            E((i) => {
              ...
              return cr(new URL(i)).pipe(
                m((a) => {
                  let p = pe().href.replace(t.base, "");
                  return a.includes(p.split("#")[0])
                    ? new URL(`../${s}/${p}`, t.base)
                    : new URL(i);
                }),
              );
      ...
      .subscribe((n) => ot(n, !0)),
      B([r, o]).subscribe(([n, i]) => {
        U(".md-header__topic").appendChild(hn(n, i));
      }),
      e.pipe(E(() => o)).subscribe((n) => {
        var s;
  ...
  function Pa(e, { worker$: t }) {
    let { searchParams: r } = pe();
    r.has("q") &&
      (Ke("search", !0),
      (e.value = r.get("q")),
      e.focus(),
    ...
    let o = Zt(e),
      n = _(t.pipe($e(Mt)), h(e, "keyup"), o).pipe(
        m(() => e.value),
        X(),
      );
    return B([n, o]).pipe(
  ...
  function Kn(e, { worker$: t }) {
    let r = new x(),
      o = r.pipe(Z(), re(!0));
    B([t.pipe($e(Mt)), r], (i, s) => s)
      .pipe(ee("value"))
      .subscribe(({ value: i }) => t.next({ type: 2, data: i })),
      r.pipe(ee("focus")).subscribe(({ focus: i }) => {
        i && Ke("search", i);
      }),
      h(e.form, "reset")
        .pipe(Y(o))
        .subscribe(() => e.focus());
    let n = U("header [for=__search]");
    return (
  ...
  function Qn(e, { worker$: t, query$: r }) {
    let o = new x(),
      n = Ko(e.parentElement).pipe(M(Boolean)),
      i = e.parentElement,
      s = U(":scope > :first-child", e),
      a = U(":scope > :last-child", e);
    We("search").subscribe((l) =>
      a.setAttribute("role", l ? "list" : "presentation"),
    ),
      o
        .pipe(ne(r), $r(t.pipe($e(Mt))))
        .subscribe(([{ items: l }, { value: f }]) => {
          switch (l.length) {
            case 0:
              s.textContent = f.length
                ? be("search.result.none")
                : be("search.result.placeholder");
              break;
            case 1:
            ...
            default:
              let u = tr(l.length);
              s.textContent = be("search.result.other", u);
          }
        });
    let c = o.pipe(
      w(() => (a.innerHTML = "")),
  ...
  function Bn(e, { worker$: t, keyboard$: r }) {
    let o = new x(),
      n = Ee("search-query"),
      i = _(h(n, "keydown"), h(n, "focus")).pipe(
        Se(ae),
        m(() => n.value),
        X(),
      );
    return (
      ...
      r.pipe(M(({ mode: a }) => a === "search")).subscribe((a) => {
        switch (a.type) {
          case "ArrowRight":
            e.innerText.length &&
  ...
  function Gn(e, { index$: t, keyboard$: r }) {
    let o = me();
    try {
      let n = zn(o.search, t),
        i = Ee("search-query", e),
        s = Ee("search-result", e);
      h(e, "click")
        .pipe(M(({ target: c }) => c instanceof Element && !!c.closest("a")))
        .subscribe(() => Ke("search", !1)),
        r.pipe(M(({ mode: c }) => c === "search")).subscribe((c) => {
          let p = Re();
          switch (c.type) {
            case "Enter":
              if (p === i) {
                let l = new Map();
                for (let f of q(":first-child [href]", s)) {
        ...
        r.pipe(M(({ mode: c }) => c === "global")).subscribe((c) => {
          switch (c.type) {
            case "f":
            case "s":
            case "/":
      ...
      let a = Kn(i, { worker$: n });
      return _(a, Qn(s, { worker$: n, query$: a })).pipe(
        qe(
          ...oe("search-share", e).map((c) => Yn(c, { query$: a })),
          ...oe("search-suggest", e).map((c) =>
            Bn(c, { worker$: n, keyboard$: r }),
          ),
        ),
      );
    } catch (n) {
      return (e.hidden = !0), Ve;
    }
  }
  function Jn(e, { index$: t, location$: r }) {
    return B([
      t,
      r.pipe(
        V(pe()),
        M((o) => !!o.searchParams.get("h")),
      ),
    ]).pipe(
      m(([o, n]) => Vn(o.config)(n.searchParams.get("h"))),
      m((o) => {
        var s;
        let n = new Map(),
        ...
        for (let [a, c] of n) {
          let { childNodes: p } = T("span", null, c);
  ...
  function Fa(e, { viewport$: t, main$: r }) {
    ...
    return B([r, t]).pipe(
      ...
      X((i, s) => i.height === s.height && i.locked === s.locked),
    );
  }
  function Kr(e, o) {
    var n = o,
      { header$: t } = n,
      r = eo(n, ["header$"]);
    let i = U(".md-sidebar__scrollwrap", e),
      { y: s } = Je(i);
    return H(() => {
      let a = new x(),
        c = a.pipe(Z(), re(!0)),
      ...
      return (
        ...
        p.pipe($e()).subscribe(() => {
          for (let l of q(".md-nav__link--active[href]", e)) {
        ...
        ge(q("label[tabindex]", e))
          ...
          .subscribe((l) => {
            let f = U(`[id="${l.htmlFor}"]`);
            U(`[aria-labelledby="${l.id}"]`).setAttribute(
              "aria-expanded",
              `${f.checked}`,
            );
          }),
  ...
  function Wa(e) {
    return (
      ...
      (ja = H(() => {
        ...
        return ei(e.href).pipe(
          w((o) => __md_set("__source", o, sessionStorage)),
        );
      }).pipe(
        de(() => L),
  ...
  function Na(e, { viewport$: t, header$: r }) {
    return ye(document.body).pipe(
      E(() => ar(e, { header$: r, viewport$: t })),
  ...
  function ri(e, t) {
    return H(() => {
      ...
      return (
        ...
        (te("navigation.tabs.sticky") ? j({ hidden: !1 }) : Na(e, t)).pipe(
          w((o) => r.next(o)),
          A(() => r.complete()),
          m((o) => R({ ref: e }, o)),
        )
  ...
  function Ua(e, { viewport$: t, header$: r }) {
    let o = new Map(),
      n = q("[href^=\\#]", e);
    for (let a of n) {
              ...
              t.pipe(
                kr(
                  ([l, f], { offset: { y: u }, size: d }) => {
                    ...
                    for (; f.length; ) {
                      let [, b] = f[0];
                      if (b - p < u || v) l = [...l, f.shift()];
                      else break;
                    }
                    for (; l.length; ) {
                      let [, b] = l[l.length - 1];
                      if (b - p >= u && !v) f = [l.pop(), ...f];
                      else break;
                    }
                    return [l, f];
                  },
  ...
  function oi(e, { viewport$: t, header$: r, main$: o, target$: n }) {
    return H(() => {
      let i = new x(),
        s = i.pipe(Z(), re(!0));
      if (
  ...
  function Da(e, { viewport$: t, main$: r, target$: o }) {
    let n = t.pipe(
        m(({ offset: { y: s } }) => s),
        Le(2, 1),
        m(([s, a]) => s > a && a > 0),
  ...
  function ni(e, { viewport$: t, header$: r, main$: o, target$: n }) {
    let i = new x(),
      s = i.pipe(Z(), re(!0));
    return (
      i.subscribe({
      ...
      r.pipe(Y(s), ee("height")).subscribe(({ height: a }) => {
        e.style.top = `${a + 16}px`;
      }),
      h(e, "click").subscribe((a) => {
        a.preventDefault(), window.scrollTo({ top: 0 });
      }),
      Da(e, { viewport$: t, main$: o, target$: n }).pipe(
        w((a) => i.next(a)),
        A(() => i.complete()),
        m((a) => R({ ref: e }, a)),
      )
  ...
  function ii({ document$: e, tablet$: t }) {
    e.pipe(
      ...
      ce((r) =>
        h(r, "change").pipe(
          Rr(() => r.classList.contains("md-toggle--indeterminate")),
          m(() => r),
        ),
      ),
      ne(t),
  ...
  function ai({ document$: e }) {
    e.pipe(
      E(() => q("[data-md-scrollfix]")),
      w((t) => t.removeAttribute("data-md-scrollfix")),
      M(Va),
      ce((t) => h(t, "touchstart").pipe(m(() => t))),
    ).subscribe((t) => {
      let r = t.scrollTop;
      r === 0
        ? (t.scrollTop = 1)
  ...
  function si({ viewport$: e, tablet$: t }) {
    B([We("search"), t])
      .pipe(
        m(([r, o]) => r && !o),
        E((r) => j(r).pipe(ze(r ? 400 : 100))),
        ne(e),
      )
      .subscribe(
        ([
  ...
  function za() {
    return location.protocol === "file:"
      ? ht(`${new URL("search/search_index.js", Qr.base)}`).pipe(
          m(() => __index),
          J(1),
        )
      : Ne(new URL("search/search_index.json", Qr.base));
  }
  ...
  var nt = No(),
    ...
    Yr = Yo(),
    Te = nn(),
    lr = Fr("(min-width: 960px)"),
    pi = Fr("(min-width: 1220px)"),
    li = Xo(),
    Qr = me(),
    mi = document.forms.namedItem("search") ? za() : Ve,
    Br = new x();
  Fn({ alert$: Br });
  var Gr = new x();
  te("navigation.instant") &&
    Wn({ location$: _t, viewport$: Te, progress$: Gr }).subscribe(nt);
  var ci;
  ((ci = Qr.version) == null ? void 0 : ci.provider) === "mike" &&
    qn({ document$: nt });
  _(_t, gt)
    .pipe(ze(125))
    .subscribe(() => {
  ...
  Yr.pipe(M(({ mode: e }) => e === "global")).subscribe((e) => {
    switch (e.type) {
      case "p":
      case ",":
        let t = se("link[rel=prev]");
        typeof t != "undefined" && ot(t);
        break;
      case "n":
      case ".":
        let r = se("link[rel=next]");
  ...
  ii({ document$: nt, tablet$: lr });
  ai({ document$: nt });
  si({ viewport$: Te, tablet$: lr });
  var Xe = kn(Ee("header"), { viewport$: Te }),
    Lt = nt.pipe(
      m(() => Ee("main")),
      E((e) => Rn(e, { viewport$: Te, header$: Xe })),
      J(1),
    ),
    qa = _(
      ...oe("consent").map((e) => cn(e, { target$: gt })),
      ...oe("dialog").map((e) => Cn(e, { alert$: Br })),
      ...oe("header").map((e) =>
        Hn(e, { viewport$: Te, header$: Xe, main$: Lt }),
      ),
      ...oe("palette").map((e) => Pn(e)),
      ...oe("progress").map((e) => In(e, { progress$: Gr })),
      ...oe("search").map((e) => Gn(e, { index$: mi, keyboard$: Yr })),
      ...oe("source").map((e) => ti(e)),
    ),
    Ka = H(() =>
      _(
        ...oe("announce").map((e) => sn(e)),
        ...oe("content").map((e) =>
          An(e, { viewport$: Te, target$: gt, print$: li }),
        ),
        ...oe("content").map((e) =>
          te("search.highlight") ? Jn(e, { index$: mi, location$: _t }) : L,
        ),
        ...oe("header-title").map((e) => $n(e, { viewport$: Te, header$: Xe })),
        ...oe("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? jr(pi, () => Kr(e, { viewport$: Te, header$: Xe, main$: Lt }))
            : jr(lr, () => Kr(e, { viewport$: Te, header$: Xe, main$: Lt })),
        ),
        ...oe("tabs").map((e) => ri(e, { viewport$: Te, header$: Xe })),
        ...oe("toc").map((e) =>
          oi(e, { viewport$: Te, header$: Xe, main$: Lt, target$: gt }),
        ),
        ...oe("top").map((e) =>
          ni(e, { viewport$: Te, header$: Xe, main$: Lt, target$: gt }),
        ),
      ),
    ),
    fi = nt.pipe(
